(function() {
  ...
  style.textContent =
    '#kit-hour-bar { background:#0d0d0d; border-bottom:2px solid #f5c842; padding:12px 15px; text-align:center; font-family:Arial,sans-serif; font-size:14px; color:#e0c96a; }' +
    ...
    '#kit-kofi-bar { background:#1a1a2e; padding:18px 15px; text-align:center; font-family:Arial,sans-serif; border-top:3px solid #e94560; }' +
    '#kit-kofi-bar p { color:#ccc; margin:0 0 10px; font-size:14px; }' +
    '#kit-kofi-bar a { display:inline-block; background:#FF5E5B; color:#fff; padding:12px 28px; border-radius:6px; text-decoration:none; font-weight:bold; font-size:15px; letter-spacing:0.3px; }' +
  ...
  kofiBar.innerHTML =
    '<p>This site is free. If it helped you, a coffee keeps it going.</p>' +
