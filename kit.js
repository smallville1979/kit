(function() {
  ...
  // Guard: only run once — prevents duplicates if script loads multiple times
  ...
  // Kill any existing nav on the page
  var existingNav = document.querySelector("nav");
  if (existingNav) existingNav.parentNode.removeChild(existingNav);
  ...
  ticker.id = "kit-ticker";
  ticker.innerHTML = '<div id="kit-ticker-inner">' +
    '<span>📌 BOOKMARK THIS PAGE — Press Ctrl+D (Cmd+D on Mac) right now &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>' +
    '<span>💬 SEND TO A MATE — <a href="https://wa.me/?text=This%20helped%20me%20out%3A%20' + encodeURIComponent(currentURL) + '">WhatsApp them this link</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>' +
    '<span>📌 BOOKMARK THIS PAGE — Press Ctrl+D (Cmd+D on Mac) right now &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>' +
    '<span>💬 SEND TO A MATE — <a href="https://wa.me/?text=This%20helped%20me%20out%3A%20' + encodeURIComponent(currentURL) + '">WhatsApp them this link</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>' +
    '<span>📌 BOOKMARK THIS PAGE — Press Ctrl+D (Cmd+D on Mac) right now &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>' +
    '<span>💬 SEND TO A MATE — <a href="https://wa.me/?text=This%20helped%20me%20out%3A%20' + encodeURIComponent(currentURL) + '">WhatsApp them this link</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>' +
  ...
  var style = document.createElement("style");
  style.textContent = '' +
    '#kit-ticker { background:#e94560; overflow:hidden; white-space:nowrap; padding:8px 0; font-family:Arial,sans-serif; }' +
    '#kit-ticker-inner { display:inline-block; animation:kit-scroll 25s linear infinite; font-size:14px; font-weight:bold; color:#fff; }' +
    '#kit-ticker-inner a { color:#fff; text-decoration:underline; }' +
    '@keyframes kit-scroll { 0% { transform:translateX(100vw); } 100% { transform:translateX(-100%); } }' +
    '#kit-nav { background:#1a1a2e; padding:10px 15px; font-family:Arial,sans-serif; position:sticky; top:0; z-index:99999; }' +
    '#kit-nav-inner { display:flex; justify-content:space-between; align-items:center; max-width:900px; margin:0 auto; }' +
    '#kit-brand { color:#e94560; font-weight:bold; font-size:18px; }' +
    '#kit-menu-btn { background:#e94560; color:#fff; border:none; padding:8px 16px; border-radius:5px; cursor:pointer; font-size:14px; }' +
  ...
  // === INJECT — NUKE EXISTING NAV FIRST ===
  document.head.appendChild(style);
  ...
  // Kill any element with id containing "nav" that isn't ours
  var existingNavId = document.querySelector('[id*="nav"]:not(#kit-nav):not(#kit-nav-inner)');
  if (existingNavId) existingNavId.parentNode.removeChild(existingNavId);
